...
const _DEFAULT_CONTROLLER_SETTINGS = {
	"/interaction_profiles/htc/vive_controller" = "res://assets/player/controller_defaults/vive_controller.tres",
	"/interaction_profiles/oculus/touch_controller" = "res://assets/player/controller_defaults/touch_controller.tres",
	"/interaction_profiles/valve/index_controller" = "res://assets/player/controller_defaults/index_controller.tres",
}
...
func get_controller_settings(
	...
	var output := load(
		_DEFAULT_CONTROLLER_SETTINGS.get(controller_name, "res://assets/player/controller_defaults/default.tres")
